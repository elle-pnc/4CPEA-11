...
import { Users, UsersRound, ArrowRight, DollarSign, TrendingUp, FileText, Clock } from 'lucide-react'
...
import { subscribeUsersByStatus, getActiveShift, startShift, endShift, subscribeDailyPassengerCount, subscribeDailyRevenue, subscribeDailyExpenses, saveDailyExpenses, subscribeJeepney, syncJeepneySeatCount, subscribeUserTripTransactions } from '../firebase/firestore'
      ...
      <div className={`dashboard-main-content ${sidebarOpen ? 'with-sidebar' : ''}`}>
        <div className="dashboard-content-wrapper">
          ...
          <div className="dashboard-grid-layout">
            ...
            <div>
              <Card className="dashboard-section animation-delay-200">
