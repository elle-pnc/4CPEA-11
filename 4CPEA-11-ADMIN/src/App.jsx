...
const ACCESS_DENIED_MSG = 'Your account does not have access to the Admin app.'
    ...
    <Router basename="/Admin">
      <Toaster
        ...
        toastOptions={{
          ...
          success: {
            iconTheme: { primary: 'var(--accent-success)', secondary: 'white' },
          },
          error: {
            iconTheme: { primary: 'var(--accent-error)', secondary: 'white' },
          },
        }}
      />
      <Routes>
